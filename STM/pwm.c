...
void init_Timer0(void)
 // set up timer to have period of 1ms
{
	LPC_TIM0->CTCR = 0x0;
...
// set up timer to have period of 1us
{
	LPC_TIM0->CTCR = 0x0;
	LPC_TIM0->PR = 25-1; //setup PR to have period of 1µs
...
//wait for delay given in delay in ms
{
